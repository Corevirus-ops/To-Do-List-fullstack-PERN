...
<section className="flex flex-col w-full items-end m-5 p-5 relative">
<button className="m-5 cursor-pointer text-gray-700 hover:text-gray-500" onMouseEnter={() => setLogoutHint(true)} onMouseLeave={() => setLogoutHint(false)} onClick={logOut} ><FaBackspace /></button>
