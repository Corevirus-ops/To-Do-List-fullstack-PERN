    ...
    return (
        ...
        <form className="flex flex-col overflow-auto" onSubmit={handleSubmit} >
            <section className="flex flex-col w-full gap-6 justify-center content-center items-center">
                <label className="p-2 flex justify-between w-1/2">Name: <input type="text" spellCheck={false} className="outline-gray-400 outline-2 rounded-md p-2" placeholder="John Smith" value={name} onChange={handleName} required/></label>
                <label className="p-2 flex justify-between w-1/2">Email: <input type="email" spellCheck={false} className="outline-gray-400 outline-2 rounded-md p-2" placeholder="email@something.com" value={email} onChange={handleEmail} required /></label>
                <label className="p-2 flex justify-between w-1/2">Confirm Email: <input type="email" spellCheck={false} className="outline-gray-400 outline-2 rounded-md p-2" placeholder="email@something.com" value={conEmail} onChange={handleConEmail} required/></label>
                <label className="p-2 flex justify-between w-1/2">Password: <div className="flex gap-2 m-2"><input spellCheck={false} type={showPass?.pass ? "text" : "password"} placeholder="password123" className="outline-gray-400 outline-2 rounded-md p-2" required value={password} onChange={handlePassword} pattern="[^\s]+"/>
                ...
                <label className="p-2 flex justify-between w-1/2">Confirm Password:<div className="flex gap-2 m-2"> <input spellCheck={false} type={showPass.passCon ? "text" : "password"} placeholder="password123" className="outline-gray-400 outline-2 rounded-md p-2" required value={conPassword} onChange={handleConPassword}  pattern="[^\s]+"/>
